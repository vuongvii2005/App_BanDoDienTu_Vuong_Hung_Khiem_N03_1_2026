                ...
                children: [
                  ...
                  const Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text('𝕏', style: TextStyle(fontSize: 24)),
                          SizedBox(width: 15),
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: const [
                            ...
                            SizedBox(height: 10),
                            Text('Wireframing', style: TextStyle(fontSize: 12)),
                            SizedBox(height: 10),
                            Text('Diagramming', style: TextStyle(fontSize: 12)),
                            SizedBox(height: 10),
                            Text(
                              'Brainstorming',
                        ...
                        Column(
                          ...
                          children: const [
                            ...
                            SizedBox(height: 10),
                            Text('Prototyping', style: TextStyle(fontSize: 12)),
                            SizedBox(height: 10),
                            Text(
                        ...
                        Column(
                          ...
                          children: const [
                            ...
                            SizedBox(height: 10),
                            Text('Color wheel', style: TextStyle(fontSize: 12)),
                            SizedBox(height: 10),
                            Text('Support', style: TextStyle(fontSize: 12)),
                            SizedBox(height: 10),
                            Text('Developers', style: TextStyle(fontSize: 12)),
                            SizedBox(height: 10),
                            Text(
                              'Resource library',
                              style: TextStyle(fontSize: 12),
